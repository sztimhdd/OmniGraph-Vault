...
def main() -> int:
    ...
    # 260819 de-Google: GCP SA hydration removed — embedding is local BGE-M3
    # via the Aliyun embed-server route (OMNIGRAPH_LOCAL_EMBED=1 in app.yaml);
    # no Google credential exists anywhere in this deploy.
