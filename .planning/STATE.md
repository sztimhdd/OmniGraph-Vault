...
Last activity: 2026-05-09 - Completed quick task 260509-syd: Cognee 422 NOT_FOUND root-cause investigation (recommended **Path B — switch Cognee to Vertex AI**, ~5 LOC change in `cognee_wrapper.py:47-51`; root cause = AI Studio model `gemini/gemini-embedding-2` is Vertex-exclusive AND production GEMINI_API_KEY is OAuth-format token rejected by AI Studio with 401; locally verified `vertex_ai/gemini-embedding-2` returns 3072-dim vector in 0.47s; investigation-only, no fix applied; commit 4a0521a)
