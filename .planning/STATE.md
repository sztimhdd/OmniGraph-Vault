...
Last activity: 2026-05-09 - Completed quick task 260509-s29 (3-wave bundle): Wave 1 v3.4 milestone closure (`a85a91a`) + Wave 2 `skip_reason_version` cohort gate (`42a1b79`) + Wave 3 LLM dispatcher unification (`e538b2d`) — milestone closed, reject-cohort gate live in `_build_topic_filter_query`, 7 production LightRAG callers route through `lib.llm_complete.get_llm_func()`
