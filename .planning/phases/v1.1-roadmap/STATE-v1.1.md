...
**Created:** 2026-05-28
**Current status:** IN-PROGRESS — Wave 0 closed; Wave 1: P5 ✅ CLOSED (2026-05-29); P1 deferred (PARKED v1.2 2026-06-01 — overtaken by client-side qa.js sweep). Wave 2: P2-3 ✅ DEPLOYED-ENABLED via perf-fix-A 2026-05-31; perf-fix-B 📋 CODE-SHIPPED + ALIYUN-DEPLOY-DEFERRED 2026-06-01 (HT-4 systemd drift halt → folded into qdrant-migration). **qdrant-migration phase (P0): Wave 1 ✅ CLOSED 2026-06-01 (6 commits, 4 atomic tasks); Wave 2 ✅ CLOSED 2026-06-02 (T5/T6/T7/T8 ssh ops + 2 PLAN-defect repo-syncs); Wave 3 🔴 T9 FAILED 2026-06-02 (1/252 done, 47 failed, 0 chunks Qdrant; root cause post-mortem in flight; re-fire pending Gemini RPD reset 20:00 ADT today + strategy revision); Wave 4 ⏳ blocked on Wave 3.**
...
| qdrant-migration | 2 | 🔴 IN-PROGRESS — Wave 1 ✅ Wave 2 ✅ Wave 3 FAILED 2026-06-02 | Aliyun ingest OOM structural fix + Aliyun rerank parity (folded #26 from perf-fix-B) + #27 hydrate throttle structural fix. **ISSUES.md #25 P0** (promoted P3→P0 2026-06-01). PR #4 `ops/qdrant-migration` extended via plan-phase. **Wave 1 ✅ CLOSED 2026-06-01** (6 commits `8a9abf3` T1 env-driven vector_storage 3 sites + `a3b08eb` T2 converter + roundtrip test + `b015dbd` T3 systemd snapshot timer + override.conf examples + reingest wrapper + `dceaec3` T4 N=4 lock-break test + `400e97f`/`36ed5ad` 2 frontmatter LoC patches; +781 LoC code/config vs PLAN +443; HT-* 0 fired; details in [qdrant-migration/PLAN.md](qdrant-migration/PLAN.md) drift log). **Wave 2 ✅ CLOSED 2026-06-02** (T5/T6/T7/T8 Aliyun ssh ops; Qdrant docker run :6333; override.conf 11→13 lines; kb-api hydrate `wall_s=15.18` ← 14min historical = 55× faster; first snapshot 3 valid empty NanoVDB JSONs; `qdrant-snapshot.timer` enabled; 2 PLAN-defect repo-syncs `0cd7a0b` T2 graceful-empty + `18903ca` defect A QDRANT_URL env). **Wave 3 🔴 T9 FAILED 2026-06-02 02:12 ADT** — wrapper self-exit at 6h11min, 1/252 articles done, 47 failed, 221 not-started, 0 chunks written to Qdrant; metrics: avg_article_time=1026.1s (17min), batch_budget=8h consumed by single article starve, OpenRouter 402×323 (NOT vision cascade — provider_mix shows 0 OpenRouter use; true caller TBD by post-mortem agent), Vertex 429×19, Gemini RPD 64.6% (323/500). Post-mortem agent in-flight; sqlite reset of 47 failed rows pending; re-fire blocked on Gemini RPD reset 20:00 ADT today + strategy revision. SiliconFlow API balance bug surfaced (returns chargeBalance=-53.93 but real backend=¥15). Wave 4 (HT-6 N=4 + SC#9 hydrate ×3 restart + Databricks deploy gate + HC-6 close) blocked on Wave 3 close. See [qdrant-migration/PLAN.md](qdrant-migration/PLAN.md) + [.planning/quick/260601-qdrant-research/RESEARCH.md](../../quick/260601-qdrant-research/RESEARCH.md) (currently untracked, queued for commit alongside Wave 3 post-mortem evidence). |
