...
kb-v2.2-7 (replaced kb-v2.2-2 F1'): the on-demand translation surface
(POST/GET /api/translate, GET /api/article/{hash}?lang=) was deleted —
bilingual rendering is site-language-driven SSG via dual-`<span data-lang>`
blocks, not API-served per-language payloads.
